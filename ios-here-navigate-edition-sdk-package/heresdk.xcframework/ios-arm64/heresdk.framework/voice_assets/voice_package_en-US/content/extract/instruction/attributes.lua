...
function attributes.get_side_of_road(side_of_destination_side)
    if side_of_destination_side == 'LEFT' or
       side_of_destination_side == 'RIGHT'or
       side_of_destination_side == 'FRONT' then
        return string.lower(side_of_destination_side)
    end
end
...
function attributes.get_exit_name(signpost_exit_name,
                                   signpost_exit_name_phoneme_nt_sampa,
                                   signpost_exit_name_phoneme_nt_sampa_lang,
                                   orthographic_language)
    local exit_name_table = {}
    if signpost_exit_name == nil or signpost_exit_name == "" then
        exit_name_table = nil
    else
        exit_name_table.content = signpost_exit_name
        exit_name_table.phonetic_form = signpost_exit_name_phoneme_nt_sampa
        exit_name_table.phonetic_language = signpost_exit_name_phoneme_nt_sampa_lang
        exit_name_table.orthographic_language = orthographic_language
    end
    return exit_name_table
end


function attributes.get_exit_number(signpost_exit_number,
                                    signpost_exit_number_phoneme_nt_sampa,
                                    signpost_exit_number_phoneme_nt_sampa_lang,
                                    orthographic_language)
    local exit_number_table = {}
    if signpost_exit_number == nil or signpost_exit_number == "" then
        exit_number_table = nil
    else
        exit_number_table.content = signpost_exit_number
        exit_number_table.phonetic_form = signpost_exit_number_phoneme_nt_sampa
        exit_number_table.phonetic_language = signpost_exit_number_phoneme_nt_sampa_lang
        exit_number_table.orthographic_language = orthographic_language
    end
    return exit_number_table
end
