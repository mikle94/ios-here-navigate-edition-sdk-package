...
function prompt._substitute_placeholders(template, prompt_table, substitutes, mods)
    ...
    local function _get_value_for_placeholder(placeholder)
        ...
        elseif placeholder == '{EXIT}' then
            value = prompt._get_exit(prompt_table.exit_number, prompt_table.exit_name, prompt_table.vp_marc_lang_code, prompt_table.vp_supported_lang_code)
        elseif placeholder == '{NEXT_EXIT}' then
            value = prompt._get_exit(prompt_table.next_exit_number, prompt_table.next_exit_name, prompt_table.vp_marc_lang_code, prompt_table.vp_supported_lang_code)
