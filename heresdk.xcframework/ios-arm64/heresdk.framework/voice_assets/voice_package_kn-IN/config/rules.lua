...
rules.filter_highway_exit_information = { Attribute = 'instruction_order',
                                          Values = { ['single'] = { Attribute = 'trigger',
                                                                    Values = { ['action'] = { Setting = {} },
                                                                               ['reminder'] = { Setting = {} },
                                                                               ['*'] = { Attribute = 'exit_info',
                                                                                         Values = { ['{exit_number}'] = { Setting = { 'exit_number' } },
                                                                                                    ['{exit_name}'] = { Setting = { 'exit_name' } },
                                                                                                    ['{exit_number,exit_name}'] = { Setting = { 'exit_number', 'exit_name' } },
                                                                                                    ['{}'] = { Setting = {} }}}}},
                                                      ['first'] = { Attribute = 'trigger',
                                                                    Values = { ['action'] = { Setting = {} },
                                                                               ['*'] = { Attribute = 'exit_info',
                           ...
                           Values = { ['single'] = { Attribute = 'leaving_highway',
                                                     Values = { ['true'] = { Setting = true },
                                                                ['false'] = { Attribute = 'trigger',
                                                                              Values = { ['action'] = { Setting = false },
                                                                                         ['*'] = { Attribute = 'exit_info',
                                                                                                   Values = { ['{exit_number}'] = { Setting = true },
                                                                                                              ['{exit_name}'] = { Setting = true },
                                                                                                              ['{exit_number,exit_name}'] = { Setting = true },
                                                                                                              ['{}'] = { Setting = false }}}}}}},
