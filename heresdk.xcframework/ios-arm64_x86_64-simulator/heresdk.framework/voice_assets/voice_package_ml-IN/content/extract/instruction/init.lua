...
function instruction.extract_arrival(input_table)
    ...
    message_content.side_of_road = attributes.get_side_of_road(input_maneuver.side_of_destination_side)
    return message_content
end
...
function instruction.extract_highway_turn(input_table)
    ...
    message_content.exit_name = attributes.get_exit_name(input_maneuver.signpost_exit_name,
                                                         input_maneuver.signpost_exit_name_phoneme_nt_sampa,
                                                         input_maneuver.signpost_exit_name_phoneme_nt_sampa_lang,
                                                         input_maneuver.signpost_exit_name_orthographic_lang)
    message_content.exit_number = attributes.get_exit_number(input_maneuver.signpost_exit_number,
                                                             input_maneuver.signpost_exit_number_phoneme_nt_sampa,
                                                             input_maneuver.signpost_exit_number_phoneme_nt_sampa_lang,
                                                             input_maneuver.signpost_exit_number_orthographic_lang)
    message_content.lane_information = attributes.get_lane_information(input_maneuver.lane_information)
    return message_content
end
